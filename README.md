...
v0.2.5. Works on ZCode desktop + headless CLI（Windows 先行）. Roadmap: per-channel report authentication, spool retention/cleanup, spawn preflight, board integration (mailbox pump for comment relays).
